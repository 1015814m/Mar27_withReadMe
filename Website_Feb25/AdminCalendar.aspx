<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminCalendar.aspx.cs" Inherits="AdminCalendar" %>
...
<html>
    ...
    <div class="w3-main" style="margin-left:340px;margin-right:40px">
      ...
      <div class="w3-container" style="margin-top:80px" id="showcase">
        ...
        <h1 class="w3-xxxlarge w3-text-red"><b>Calendar</b></h1>
    ...
    <div class="w3-container" id="administration" style="margin-top: 75px;">
        <form id="feed" runat="server">
            ...
            <asp:Label ID="lblCreatEvent" runat="server" Text="Create an event"></asp:Label>
            <asp:Label ID="lblName" runat="server" Text="Enter a name for the event: "></asp:Label>
            <asp:TextBox ID="txtName" runat="server"></asp:TextBox>
            <br />
            <asp:Label ID="lblDate" runat="server" Text="Enter a date: "></asp:Label>
            <asp:TextBox ID="txtDate" runat="server"></asp:TextBox>
            <br />
            <asp:Label ID="lblTime" runat="server" Text="Enter a start time: "></asp:Label>
